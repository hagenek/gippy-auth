...
function Dashboard() {
  ...
  const createCredentials = () => {
    if (googleCreds.id == "" || googleCreds.secret == "") {
      ...
      axios
        .post("http://localhost:5000/api/get_credentials", {
  ...
  return (
    <main className="flex min-h-screen w-full flex-col gap-3 items-start justify-start p-4 py-8 md:p-24 bg-slate-200">
      ...
      <div>
        <h4 className="mb-1 text-5xl">
          Welcome to <b>GPTAuth</b>
        </h4>
        <span>
          Create your unique credentials to use in your GPT, using your{" "}
          <a
      ...
      {created == false ? (
        <>
          <div className="md:w-1/2 w-full">
            ...
            <div className="flex gap-2">
              <input
                id="id"
                className="bg-gray-50 border border-gray-300 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                value={googleCreds.id}
                onChange={(e) =>
                  setGoogleCreds({
                    id: e.target.value,
                    secret: googleCreds.secret,
                  })
                }
              />
            </div>
          ...
          <div className="md:w-1/2 w-full">
            <label htmlFor="secret" className="block mb-1 text-sm font-medium ">
            ...
            <div className="flex gap-2">
              <input
                ...
                type="password"
                className="bg-gray-50 border border-gray-300 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                value={googleCreds.secret}
                onChange={(e) =>
                  setGoogleCreds({ secret: e.target.value, id: googleCreds.id })
                }
              />
            </div>
          </div>
          <button
            className="flex items-center justify-center py-4 bg-slate-700 px-4 py-3 text-white gap-2"
        ...
        <>
          <div className="md:w-1/2 w-full">
            ...
            <div className="flex gap-2">
              ...
              />
              <button
                onClick={() => copyCredential(credentials.id)}
                className="flex items-center justify-center py-4 bg-slate-700 px-3 py-2 text-white"
              >
                <Image height={20} width={20} src="/copy.svg" />
              </button>
          ...
          <div className="md:w-1/2 w-full">
            ...
            <div className="flex gap-2">
              ...
              />
              <button
                onClick={() => copyCredential(credentials.secret)}
                className="flex items-center justify-center py-4 bg-slate-700 px-3 py-2 text-white"
              >
                <Image height={20} width={20} src="/copy.svg" />
              </button>
          ...
          <div className="md:w-1/2 w-full">
            ...
            <div className="flex gap-2">
              ...
              />
              <button
                onClick={() => copyCredential(URLs.auth)}
                className="flex items-center justify-center py-4 bg-slate-700 px-3 py-2 text-white"
              >
                <Image height={20} width={20} src="/copy.svg" />
              </button>
          ...
          <div className="md:w-1/2 w-full">
            ...
            <div className="flex gap-2">
              ...
              />
              <button
                onClick={() => copyCredential(URLs.token)}
                className="flex items-center justify-center py-4 bg-slate-700 px-3 py-2 text-white"
              >
                <Image height={20} width={20} src="/copy.svg" />
              </button>
